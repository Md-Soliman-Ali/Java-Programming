...
public class Basic_Array_Part5 {

    // Find The Date Difference Between Birthdate And Today
    public static void main(String[] args) throws ParseException {
        dateDifference();
    }

    public static void dateDifference() throws ParseException, ParseException {
